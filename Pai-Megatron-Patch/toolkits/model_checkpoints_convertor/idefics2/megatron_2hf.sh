...
MEGATRON_PATCH_PATH=/your_path_to/Pai-Megatron-Patch
MEGATRON_PATH=${MEGATRON_PATCH_PATH}/Megatron-LM-240424

SOURCE_CKPT_PATH=/apdcephfs_us/share_300814644/data/nlp/megatron_models/idefics2-8b-instruct/idefics2-mistral-megatron-tp-8-pp-1/release
...
TARGET_CKPT_PATH=/apdcephfs_us/share_300814644/data/nlp/huggingface_models/mg-idefics2-8b
