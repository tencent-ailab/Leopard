...
from megatron.core.models.common.embeddings.rotary_pos_embedding import apply_rotary_pos_emb as apply_rotary_pos_emb_megatron
...
class ParallelAttention(MegatronModule):
    ...
    def __init__(self, config, layer_number,
        ...
        if args.use_mistral_rotary_position_embeddings or args.use_llama2_rotary_position_embeddings:
            self.use_user_rotary_position_embeddings = True
            ...
            if args.use_mistral_rotary_position_embeddings:
                ...
                from .rotary_pos_embedding_llama3 import RotaryEmbedding
            ...
            self.use_user_rotary_position_embeddings = False
    ...
    def forward(self, hidden_states, attention_mask,
        ...
        if inference_params:
            if self.use_user_rotary_position_embeddings:
                ...
                if self.args.use_mistral_rotary_position_embeddings:
                    from .rotary_pos_embedding import apply_rotary_pos_emb
                elif self.args.use_llama2_rotary_position_embeddings:
                    from .rotary_pos_embedding_llama3 import apply_rotary_pos_emb
        ...
        if self.use_user_rotary_position_embeddings:
            ...
            if rotary_pos_emb is not None:
                q_pos_emb, k_pos_emb = rotary_pos_emb
                query_layer = apply_rotary_pos_emb_megatron(query_layer, q_pos_emb, self.config)
                key_layer = apply_rotary_pos_emb_megatron(key_layer, k_pos_emb, self.config)
                # TODO, can apply positional embedding to value_layer so it has
                # absolute positional embedding.
                # otherwise, only relative positional embedding takes effect
                # value_layer = apply_rotary_pos_emb_megatron(value_layer, k_pos_emb)
...
class ParallelTransformer(MegatronModule):
    ...
    def load_state_dict(self, state_dict, strict=True):
        ...
        if args.use_llama2_rotary_position_embeddings or args.use_mistral_rotary_position_embeddings:
