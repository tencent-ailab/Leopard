...
class TransformerLanguageModel(MegatronModule):
    ...
    def __init__(self,
        ...
        if args.use_rotary_position_embeddings:
            ...
            self.rotary_pos_emb = RotaryEmbedding(
                rotary_dim, rotary_percent=args.rotary_percent,
                seq_len_interpolation_factor=args.rotary_seq_len_interpolation_factor, rotary_base=args.rotary_base
            )
    ...
    def load_state_dict(self, state_dict, strict=True):
        """Customized load."""
        args = get_args()
        print ('state dict', list(state_dict.keys()))
        # Embedding.
        if self.pre_process:
