...
def get_patch_args(parser):
    ...
    group.add_argument('--pad-vocab-size',
                       type=int,
                       default=0,
                       help='--pad-vocab-size')

    group.add_argument('--force-add-eos-token',
                       action='store_true',
                       help='Whether to add an eos token for Idefics2 processor. Be careful on this and it should not be applied to Chat-based models.')
    ...
    group.add_argument('--use-llama2-rotary-position-embeddings', action='store_true',
                       ...
                       'Deprecated: use --use-rotary-position-embeddings')
    ...
    #                    help='Use pai-megatron implemented rotary positional embeddings or not. ')
    ...
    group.add_argument('--freeze-perceiver',
                       action='store_true')

    group.add_argument('--answer-loss-only',
                       action='store_true')
    ...
    group.add_argument('--vision-tower',
                       type=str,
                       default='',
                       help='path to the vision tower for multimodal models')
    
    group.add_argument('--image-seq-len',
                       type=int,
                       default=64,
                       help='length of image tokens, for idefics2')
    group.add_argument('--max-image-num',
                       type=int,
                       default=1,
                       help='length of image tokens, for idefics2')
    ...
    group.add_argument('--mm-connector',
                       type=str,
                       default=None,
                       help="for idefics2. path to the mm connector weight")
    ...
    group.add_argument('--shortest-edge',
                       type=int,
                       default=None,
                       help='shortest-edge')
    ...
    group.add_argument('--do-image-splitting', action='store_true', help='whether do image splitting in idefics2')
